...
<template>
	<header class="mx-auto px-4 bg-blue-200 fixed w-full z-50 flex items-center justify-between">
		...
		<div id="menu" :class="{hidden: !mobileMenu, 'md:block': true}">
			<ul class="text-3xl md:text-base flex flex-col md:flex-row justify-center items-center fixed md:relative md:pr-10 top-0 bottom-0 left-0 right-0 bg-blue-200 z-20">
